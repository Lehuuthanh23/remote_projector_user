              ...
              Center(
                child: viewModel.isImage
                    ? SizedBox(
                        ...
                        child: widget.videoType == 1
                            ? Image.file(File(widget.urlFile))
                            : Image.network(widget.urlFile),
                      )
                    : Column(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 10, right: 55),
                                      child: Text(
                                        'Đang phát: ${path.basename(widget.urlFile)}',
                                        maxLines: 2,
                                    ...
                                    ConstrainedBox(
                                      ...
                                      child: Center(
                                        child: AspectRatio(
                                          aspectRatio:
                                              viewModel.getAspectRatio(),
                                          child: Stack(
                                            children: [
                                              viewModel.mobileVideoController !=
                                                      null
