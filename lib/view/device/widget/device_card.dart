                  ...
                  children: [
                    ...
                    if (widget.isDetail)
                      LineInfoDevice(
                        ...
                        rightText:
                            convertDateTimeFormat(widget.data.lastedAliveTime),
                        margin: const EdgeInsets.only(top: 5),
                  ...
                  children: [
                      ...
                      child: CampLineAction(
                        ...
                        onTap: () {
                          SearchCustomerDialog.show(
                              context, widget.deviceViewModel, (customerId) {
                    ...
                    Expanded(
                      child: CampLineAction(
                        ...
                        iconInRight: true,
                        onTap: () {
                          widget.deviceViewModel.setCurrentDevice(widget.data);
                          showDialog(
                            context: context,
                                ...
                                onTap: () async {
                                  ...
                                  if (checkMoved && context.mounted) {
                                    ...
                                    showPopupSingleButton(
                                      title:
                                          'Đã chuyển thiết bị sang thư mục $externalDir thành công',
                                      context: context,
                                    );
                                  }
                                },
                          ...
                          ? ListTile(
                              ...
                              onTap: () async {
                                ...
                                if (checkMoved && context.mounted) {
                                  ...
                                  showPopupSingleButton(
                                    title:
                                        'Đã chuyển thiết bị sang thư mục ${dir.dirName} thành công',
                                    context: context,
                                  );
                                }
                              },
